...
export function Navigation() {
  ...
  const navLinks = [
    ...
    { label: "场景", href: "#flavours" },
    { label: "参考", href: "#creators" },
    { label: "入口", href: "#distributors" },
  ]
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <motion.span
            className="flex items-baseline gap-1.5 text-2xl font-black tracking-tighter"
          ...
          >
            ...
            <span className={`text-sm font-mono tracking-tight ${scrolled ? "text-white/70" : "text-[#121212]/60"}`}>
              Banana Slides
            </span>
          </motion.span>
        </Link>
