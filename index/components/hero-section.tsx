          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              <motion.p
                ...
                animate="visible"
                custom={3}
                className="text-base md:text-lg text-[#121212]/70 leading-relaxed pt-3 max-w-md text-pretty"
              >
            ...
            >
              {["结构化", "视觉化", "多场景", "参考生成"].map((benefit, i) => (
                <motion.div
                  key={benefit}
            ...
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              ...
              >
                <Image
                  ...
                  width={560}
                  height={420}
                  className="relative z-10 rounded-2xl border border-[#121212]/10 shadow-2xl"
                  priority
                />
              </motion.div>
            </motion.div>
