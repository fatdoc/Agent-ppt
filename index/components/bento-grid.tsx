...
import { Layers, Type, ImageIcon, FileOutput } from "lucide-react"
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="overflow-hidden mt-2">
            <motion.h2
              className="text-3xl md:text-4xl font-black text-white tracking-tight text-balance"
              initial={{ y: 60 }}
          ...
          <motion.p
            className="text-white/50 text-sm md:text-base leading-relaxed max-w-xl mx-auto mt-4 text-pretty"
            initial={{ opacity: 0 }}
            animate={isInView ? { opacity: 1 } : { opacity: 0 }}
